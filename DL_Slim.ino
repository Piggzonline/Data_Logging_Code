//PICARD Data Logging Script 2

//This sketch was written by: Michael McCallum

//This sketch records the data during the PICARD experiment
...
{
x = EEPROM.read(addr);      //read eeprom for time
 {
  if (x <= 10)
{
  ...
  for (int analogPin = 0; analogPin < 6; analogPin++) {   // read six sensors and append to the string
